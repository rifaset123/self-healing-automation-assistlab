...
export const khsLocators = {
  ...
  uploadedKhsFileName: (page: Page, filename: string) => page.getByText(filename),
  ...
  verifyFilteredData: (page: Page, search: string) => page.locator("tbody tr td").filter({ hasText: search }), // DC
