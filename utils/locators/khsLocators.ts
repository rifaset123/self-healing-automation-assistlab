...
export const khsLocators = {
  sidebarKhsButton: (page: Page) => page.getByTestId("sidebarKhs"), // LC - Updated from sidebar-khs
  ...
  uploadKhsInput: (page: Page) => page.locator("input[type='file'][name='khsFile']"), // LC - Updated from #khsFile ID selector
  ...
  verifySortFilter: (page: Page) => page.getByRole("button", { name: "Mata Kuliah" }), // LC - Updated from #mata-kuliah-row
